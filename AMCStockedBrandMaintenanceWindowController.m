//
//  AMCStockedBrandMaintenanceWindowController.m
//  ClaudiasSalon
//
...
@interface AMCStockedBrandMaintenanceWindowController ()

@end

@implementation AMCStockedBrandMaintenanceWindowController
...
-(NSString *)windowNibName {
    return @"AMCStockedBrandMaintenanceWindowController";
}
